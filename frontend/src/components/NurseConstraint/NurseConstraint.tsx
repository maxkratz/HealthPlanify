        ...
        <div className={containerClassName}>
            ...
            {s2MinimumSkillLevel !== 0 && (
                <div className={`flex items-center justify-center flex-row gap-2`}>
                    <FlagBanner size={22} weight="fill" color="var(--color-black)" />
            ...
            {s3CareContinuity !== 0 && (
                <div className={`flex items-center justify-center flex-row gap-2`}>
                    <Heart size={22} weight="fill" color="var(--color-black)" />
            ...
            {s4MaximumWorkload !== 0 && (
                <div className={`flex items-center justify-center flex-row gap-2`}>
                    <BatteryFull size={22} weight="fill" color="var(--color-black)" />
