...
export function calculateNurseGlobalConstraints(
    ...
    // B. Contribución a S3 a partir de los ocupantes (presente desde el día 0).
    ...
    // --- Cálculo de S2 y S4: Penalizaciones globales acumuladas ---
    inputData.nurses.forEach(nurse => {
        let S2_total = 0;
        let S4_total = 0;
        ...
        if (nurseSolution) {
            nurseSolution.assignments.forEach(assignment => {
                ...
                // Filtra a los pacientes asignados en la asignación actual.
                ...
                // S2: Acumula la diferencia entre lo requerido y la habilidad de la enfermera.
                ...
                // S4: Acumula la penalización por excedente de workload si supera el máximo permitido.
